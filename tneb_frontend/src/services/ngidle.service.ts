...
export class NgidleService {
  ...
  private initListener(): void {
    this.zone.runOutsideAngular(() => {
      ...
      window.document.addEventListener('mouseenter', this.userActivityChangeCallback.bind(this), true);
    });
  }
  ...
  private check(): void {
    ...
    .subscribe(() => {
      ...
      if (isTimeout) {
        ...
        window.document.removeEventListener('keydown', this.userActivityChangeCallback, true);
        window.document.removeEventListener('mouseenter', this.userActivityChangeCallback, true);
        this.zone.run(() => {
          if (this.userIdlenessChecker) {
