...
@Component({
  selector: 'app-personalcommun',
  templateUrl: './personalcommun.component.html',
  styleUrls: ['./personalcommun.component.scss']
})
export class PersonalcommunComponent implements OnInit {
  ...
  challengeData: Date;
  datestr: Date;
  type_Description1: any;
  type_Description2: any;
  longidnumber: any;
  systemid: any;
  constructor(
  ...
  ngOnInit(): void {
    ...
    // this.loader.show();
    this.apiservice.getpersonalcommunicationdetails(result).then((result)=>{
      // this.loader.hide();
      if(result !=null){
        const apiResponse=result;
       this.type_Description1=result[0]['type_Description'];
       this.type_Description2=result[1]['type_Description'];
       this.longidnumber=result[0]['longIDNumber'];
       this.systemid=result[1]['systemID'];
      }
    })
