...
@Component({
  selector: 'app-personalids',
  templateUrl: './personalids.component.html',
  styleUrls: ['./personalids.component.scss']
})
export class PersonalidsComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    // this.loader.show();
    this.apiservice.getpersonalidsdetails(result).then((result)=>{
      // this.loader.hide();
      if(result !=null){
        const apiResponse=result;
        // result.birthdate=this.challengeData ;
        this.FamilyForm=result;
      }
    })
