...
@Component({
  selector: 'app-personachallangesdet',
  templateUrl: './personachallangesdet.component.html',
  styleUrls: ['./personachallangesdet.component.scss']
})
export class PersonachallangesdetComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    // this.loader.show();
    this.apiservice.getpersonaldetails(result).then((result)=>{
      // this.loader.hide();
      if(result !=null){
        const apiResponse=result;
        
        this.challengeData = this.convertDateString(apiResponse.challengedate1);
        // this.challengeData.challengedate2 = this.convertDateString(apiResponse.challengedate2);
        this.challengeData1 = this.convertDateString(apiResponse.startDate);
        this.challengeData2 = this.convertDateString(apiResponse.endDate);
        result.challengedate1=this.challengeData1 ;
        result.startDate=this.challengeData2;
        this.personalform.push(result);
