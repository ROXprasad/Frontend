...
@Component({
  selector: 'app-loapply',
  templateUrl: './loapply.component.html',
  styleUrls: ['./loapply.component.scss']
})
export class LoapplyComponent implements OnInit {
  ...
  back(){
      this.route.navigateByUrl('/mssdashbaord');
  }
